...
{
public:
    PostProcessor(const std::weak_ptr<Markdown> &markdown_instance);
     ...
     *
     */
    virtual QString run(const QString &text) = 0;
...
typedef OrderedDict<std::shared_ptr<PostProcessor>> OrderedDictPostProcessors;
