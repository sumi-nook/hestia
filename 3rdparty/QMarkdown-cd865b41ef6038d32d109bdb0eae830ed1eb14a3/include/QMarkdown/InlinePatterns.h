...
public:
     ...
     *
     */
    Pattern(const QString &pattern, const std::weak_ptr<Markdown> &markdown_instance=std::weak_ptr<Markdown>());

    /*!
     * Return a compiled regular expression.
     */
    QRegularExpression getCompiledRegExp(void) const
     ...
     */
    virtual QString unescape(const QString &text);

protected:
    QString pattern;
    QRegularExpression compiled_re;
    bool safe_mode;
...
typedef OrderedDict<std::shared_ptr<Pattern>> OrderedDictPatterns;
